...
const CustomerDash = (props) => {
  ...
  return (
    <div>
      <div>
        <Link onClick={props.fun} to="/home">
          LOGO
        </Link>
        <h1 className={`text-light font-weight-light text-muted`}>Sajal</h1>
        <h5 className={`text-light font-weight-lighter text-muted`}>
          Customer
        </h5>
      </div>
      <div>
        <div className={`my-5`}>
          <h5
            className={`text-light font-weight-normal mt-5 text-decoration-none btn `}
          >
            Active Trips
          </h5>
